...
X_path_train = 'X_train.npy'
Y_path_train = 'Y_train.npy'

X_path_test = 'X_test.npy'
Y_path_test = 'Y_test.npy'

# Instantiate dataset
dataset_train = AFBeatDataset(X_path_train, Y_path_train)
dataset_test = AFBeatDataset(X_path_test, Y_path_test)
